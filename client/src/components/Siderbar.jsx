...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[#eae4de] dark:bg-[#eae4de] ">
      <ul class="space-y-2 font-medium">
         <li>
            <Link href="/" class="flex items-center p-2 text-gray-600 rounded-lg dark:text-gray-600 hover:bg-[#eadac9] dark:hover:bg-[#eadac9] group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-[#eadac9] dark:hover:bg-bg-[#eadac9] group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-600 hover:bg-[#eadac9] dark:hover:bg-[#eadac9] group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Today Tasks</span>
            </a>
         </li>
