...
<nav className="bg-white border-gray-200 dark:bg-[#8e80ed]">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <Link href="/">
        <span className=" text-2xl font-semibold whitespace-nowrap dark:text-white">Do.</span>
    </Link>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-[#8e80ed] md:dark:bg-[#]">
        <li>
          <Link href="/" class="block py-2 px-3 text-white bg-[#6457bf]rounded-sm md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Home</Link>
        </li>
        <li>
